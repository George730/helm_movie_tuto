...
data=pd.read_csv('kafka_movielog_rate.csv', header=None, names = ["DTG","user_id","request"])
...
print("here")
data.to_csv("10000_augmented_kafka_rate.csv", index=False)
...
data.to_csv("10000_augmented_mediumclean_kafka_rate.csv", index=False)
